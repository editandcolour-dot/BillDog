...
## DO NOT USE WHEN
- The request is to write a Python script or helper function
- The deliverable is any file other than a SKILL.md
- The user says "create" but means general code creation

> **Only trigger when the explicit deliverable is a new `.agents/skills/[name]/SKILL.md` file.**

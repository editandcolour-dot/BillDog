      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-[6%] animate-fade-up">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
                ...
                <div className="bg-navy rounded-2xl p-6 md:p-8 relative overflow-hidden text-center">
                  ...
                  <p className="text-white/70 text-sm mb-6 font-body">
                    {c.status === 'letter_ready'
                      ...
                      : 'This dispute letter has already been sent to your municipality.'}
                  </p>
                  <Link 
                    href={`/letter/${c.id}`}
                  ...
                  >
                    ...
                    <span className="relative z-10 flex items-center">
                      {c.status === 'letter_ready' ? 'Review & Send Letter' : 'Open Sent Dispute Letter'}
            ...
            {/* Awaiting municipality reply — Billdog monitors the inbox and
                auto-charges the 15% success fee on confirmed credit. The user
                does NOT confirm resolution manually. */}
            {(c.status === 'sent' || c.status === 'acknowledged' || c.status === 'escalated') && (
              <div className="bg-white border border-light-grey rounded-2xl p-6 md:p-8 text-center shadow-sm">
                <div className="w-12 h-12 bg-blue/10 text-blue rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <h3 className="font-display text-xl text-navy uppercase tracking-wide mb-3">Awaiting municipality reply</h3>
                <p className="text-grey text-sm font-body leading-relaxed mb-4">
                  Billdog is monitoring the dispute inbox on your behalf. When the municipality confirms a credit or refund, we&apos;ll automatically charge the 15% success fee to your saved card — no action needed from you.
                </p>
              </div>
            )}
